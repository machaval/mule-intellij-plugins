...
public class WeavePsiUtils {
  ...
  public static List<IElementType> OperatorsToken = Arrays.asList(WeaveTypes.WHEN, WeaveTypes.IS, WeaveTypes.AS, WeaveTypes.UNLESS, WeaveTypes.OTHERWISE, WeaveTypes.USING, WeaveTypes.DEFAULT, WeaveTypes.RULE_MATCH_LITERAL);
