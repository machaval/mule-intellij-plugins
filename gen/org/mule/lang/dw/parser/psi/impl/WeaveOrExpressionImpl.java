...
public class WeaveOrExpressionImpl extends WeaveExpressionImpl implements WeaveOrExpression {

  public WeaveOrExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitOrExpression(this);
