...
public class WeaveRightLeftExpressionImpl extends WeaveExpressionImpl implements WeaveRightLeftExpression {

  public WeaveRightLeftExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitRightLeftExpression(this);
