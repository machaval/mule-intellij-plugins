...
public class WeaveMultiplicationDivisionExpressionImpl extends WeaveExpressionImpl implements WeaveMultiplicationDivisionExpression {
  ...
  public WeaveMultiplicationDivisionExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitMultiplicationDivisionExpression(this);
