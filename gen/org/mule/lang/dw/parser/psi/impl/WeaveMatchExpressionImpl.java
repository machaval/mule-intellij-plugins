...
public class WeaveMatchExpressionImpl extends WeaveExpressionImpl implements WeaveMatchExpression {

  public WeaveMatchExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitMatchExpression(this);
