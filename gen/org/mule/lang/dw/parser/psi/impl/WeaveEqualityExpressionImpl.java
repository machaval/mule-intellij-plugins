...
public class WeaveEqualityExpressionImpl extends WeaveExpressionImpl implements WeaveEqualityExpression {

  public WeaveEqualityExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitEqualityExpression(this);
