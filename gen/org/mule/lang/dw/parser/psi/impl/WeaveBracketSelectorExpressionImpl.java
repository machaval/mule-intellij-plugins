...
public class WeaveBracketSelectorExpressionImpl extends WeaveExpressionImpl implements WeaveBracketSelectorExpression {
  ...
  public WeaveBracketSelectorExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitBracketSelectorExpression(this);
  ...
  public WeaveSelector getSelector() {
    return findNotNullChildByClass(WeaveSelector.class);
  }
