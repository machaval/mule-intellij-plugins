...
public class WeaveAsExpressionImpl extends WeaveExpressionImpl implements WeaveAsExpression {

  public WeaveAsExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitAsExpression(this);
