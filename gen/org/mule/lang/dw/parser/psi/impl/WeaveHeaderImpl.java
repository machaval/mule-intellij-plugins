...
public class WeaveHeaderImpl extends ASTWrapperPsiElement implements WeaveHeader {

  public WeaveHeaderImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof WeaveVisitor) ((WeaveVisitor)visitor).visitHeader(this);
