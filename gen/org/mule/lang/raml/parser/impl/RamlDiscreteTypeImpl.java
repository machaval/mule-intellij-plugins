...
public class RamlDiscreteTypeImpl extends ASTWrapperPsiElement implements RamlDiscreteType {

  public RamlDiscreteTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RamlVisitor) ((RamlVisitor)visitor).visitDiscreteType(this);
