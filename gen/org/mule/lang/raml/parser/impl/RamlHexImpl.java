...
public class RamlHexImpl extends ASTWrapperPsiElement implements RamlHex {

  public RamlHexImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RamlVisitor) ((RamlVisitor)visitor).visitHex(this);
