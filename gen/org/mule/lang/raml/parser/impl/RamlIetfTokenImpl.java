...
public class RamlIetfTokenImpl extends ASTWrapperPsiElement implements RamlIetfToken {

  public RamlIetfTokenImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RamlVisitor) ((RamlVisitor)visitor).visitIetfToken(this);
