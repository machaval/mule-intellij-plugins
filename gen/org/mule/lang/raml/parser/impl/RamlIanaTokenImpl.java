...
public class RamlIanaTokenImpl extends ASTWrapperPsiElement implements RamlIanaToken {

  public RamlIanaTokenImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof RamlVisitor) ((RamlVisitor)visitor).visitIanaToken(this);
