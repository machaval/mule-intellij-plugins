...
public class MelForExpressionImpl extends MelExpressionImpl implements MelForExpression {

  public MelForExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof MelVisitor) ((MelVisitor)visitor).visitForExpression(this);
